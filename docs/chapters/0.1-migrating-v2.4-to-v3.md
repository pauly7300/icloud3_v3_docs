...
3. Open *The Configurator* and review each of the screens. The most important screens are:
   ...
   - *iCloud3 Devices > iCloud3 Device Tracker Entities* - Review each of the devices you are tracking. 
     ...
     !>  When the devices are migrated, only one device will be tracked, the others are set to *Inactive*.  There have been problems starting iCloud3 for the first time caused by migrating old devices, unlocatible devices and devices that no longer in an iCloud account. Review each of  the devices:
   
     - Set the *Tracking Mode* parameter of the devices you want to track to *Track*.
   
     - Delete the devices you do not want to track.
