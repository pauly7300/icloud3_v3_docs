...
#### Updating the Lovelace Resource  {docsify-ignore}
...
#### Clearing the Browser's Cache  {docsify-ignore}
...
#### Clearing the Home Assistant Companion (iOS App) Cache  {docsify-ignore}
...
#### Exit *The Configurator* and Restart iCloud3  {docsify-ignore}
