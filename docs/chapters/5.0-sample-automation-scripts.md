...
The following automations and scripts are one example of how I am using using iCloud3 for presence detection. Specifically, these show how I open my garage door when I arrive home.
